        ...
        <AnimatePresence>
          ...
          <FadeUp key="description-1" duration={0.6} delay={0.2}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              ...
              a website, mobile app, or any digital product, I bring my
          ...
          <FadeUp key="description-2" duration={0.6} delay={0.4}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              ...
              showcasing my expertise in React.js, React Native, Next.js,
              Node.js, JavaScript, TypeScript and full-stack web and mobile
              development.
            </p>
          </FadeUp>
          <FadeRight
